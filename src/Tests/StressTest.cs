    ...
    public class StressTest
    {
        ...
        public void TestDeepNesting_Wide()
        {
            ...
            var config = new ReprConfig(
                MaxElementsPerCollection: 10,
                MaxPropertiesPerObject: 15,
                MaxDepth: 3
            );
        ...
        public void TestLargeCollections()
        {
            ...
            var largeArray = Enumerable.Range(start: 0, count: 1000)
                                       .ToArray();
            var config = new ReprConfig(MaxElementsPerCollection: 50);
        ...
        public void TestPerformance_LargeObject()
        {
            ...
            var complexObject = new
            {
                ...
                Data = Enumerable.Range(start: 0, count: 1000)
                                 ...
                                 .ToArray(),
                Config = new ReprConfig(MaxElementsPerCollection: 100)
            };
