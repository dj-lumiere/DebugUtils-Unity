...
namespace DebugUtils.Unity.Repr.Formatters
{
    ...
    internal class GameObjectFormatter : IReprFormatter, IReprTreeFormatter
    {
        public string ToRepr(object obj, ReprContext context)
        {
            ...
            return $"{t.gameObject.GetScenePath()} @ {t.transform.position.Repr()}";
        }
        ...
        public JToken ToReprTree(object obj, ReprContext context)
        {
            ...
            if (context.Config.MaxItemsPerContainer >= 0 &&
                maxChildren > context.Config.MaxItemsPerContainer)
            {
                maxChildren = context.Config.MaxItemsPerContainer;
            }
            ...
            if (context.Config.MaxItemsPerContainer >= 0 &&
                childCount > context.Config.MaxItemsPerContainer)
            {
                var truncatedCount = childCount - context.Config.MaxItemsPerContainer;
        ...
        public JToken ToReprTree(object obj, ReprContext context)
        {
            ...
            return new JObject
            {
                ...
                [propertyName: "constraints"] =
                    rb.constraints.FormatAsJToken(context: context.WithIncrementedDepth()),
                // Sleep State
                [propertyName: "sleepMode"] =
                    rb.sleepMode.FormatAsJToken(context: context.WithIncrementedDepth()),
                [propertyName: "IsSleeping"] = new JValue(value: rb.IsSleeping()
                   .ToString()
                   .ToLowerInvariant()),
                // Interpolation
